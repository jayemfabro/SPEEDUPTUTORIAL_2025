...
const TeachersDashboard = ({ stats: initialStats }) => {
    ...
    useEffect(() => {
        const fetchStats = async () => {
            setLoading(true);
            try {
                const response = await window.axios.get(`/api/admin/dashboard/stats/teacher/${auth.user.id}`);
                setStats(response.data);
            } catch (error) {
                console.error('Error fetching stats:', error);
            } finally {
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <div className="flex items-baseline">
                                    ...
                                    <span className="ml-2 text-xs text-green-600 font-medium">This month</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <div className="flex items-baseline">
                                    ...
                                    <span className="ml-2 text-xs text-navy-600 font-medium">From cancelled</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <div className="flex items-baseline">
                                    ...
                                    <span className="ml-2 text-xs text-navy-600 font-medium">{loading ? '...' : (stats.monthlyFreeClassNotConsumed || 0)} not used</span>
                                </div>
                            </div>
                        </div>
                    </div>
